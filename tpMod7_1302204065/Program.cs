...
namespace tpmodul7_1302204065 // Note: actual namespace depends on the project name.
{
    class Program
    {
    ...
    public class UIconfig
    {
        ...
        {
            String configJsonData = File.ReadAllText(filePath + "D:/ Tugas Kuliah / Semester IV / Konstruksi PL / Praktikum_kpl / TP / tpMod7 / tpMod7_1302204065 / covid_config.json");
